...
def borrar_tabla():
    ...
    try:
        ...
        mensaje = 'La tabla de la base de datos fue borrada con éxito'
        messagebox.showinfo(titulo,mensaje)
    except:
        titulo = 'Borrar registro'
...
class Pelicula:
    ...
    def __str__(self):#para ver el estado de este objeto
...
def guardar(pelicula):
    ...
    try:
        ...
        mensaje = 'La tabla peliculas no esta creado en ila base de datos'
        messagebox.showerror(titulo,mensaje)
